...
(function($PS) {
  ...
  var toString = function (dictFunctor) {
      return function (dictFoldable) {
          return Data_Functor.map(dictFunctor)(function ($57) {
              return Data_String_Yarn.fromChars(Data_Foldable.foldableArray)(Data_Array.fromFoldable(dictFoldable)($57));
          });
      };
  };
  ...
  var ruralAddressLine = Data_Functor.map(Data_Functor.functorFn)(toString(Text_Parsing_StringParser.functorParser)(Data_List_Types.foldableNonEmptyList))(Text_Parsing_StringParser_Combinators.many1)(Text_Parsing_StringParser_CodeUnits.satisfy(function (c) {
  ...
  var addressParserA3 = Control_Bind.bind(Text_Parsing_StringParser.bindParser)(word)(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
          return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(addressLine)(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipComma)(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
                      return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Control_Alt.alt(Text_Parsing_StringParser.altParser)(Text_Parsing_StringParser["try"](ruralAddressLine))(Text_Parsing_StringParser["try"](addressLine)))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipComma)(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipComma)(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
                      return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Control_Alt.alt(Text_Parsing_StringParser.altParser)(Text_Parsing_StringParser["try"](ruralAddressLine))(Text_Parsing_StringParser["try"](addressLine)))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipComma)(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
                                  return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Control_Alt.alt(Text_Parsing_StringParser.altParser)(Text_Parsing_StringParser["try"](ruralAddressLine))(Text_Parsing_StringParser["try"](addressLine)))(function (v3) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipComma)(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
  ...
  var addressPostalParserA3 = Control_Bind.bind(Text_Parsing_StringParser.bindParser)(poBox)(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipComma)(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
              return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Control_Alt.alt(Text_Parsing_StringParser.altParser)(Text_Parsing_StringParser["try"](ruralAddressLine))(Text_Parsing_StringParser["try"](addressLine)))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipComma)(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
                          return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(addressLine)(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
  ...
  var residentialParser = Control_Alt.alt(Text_Parsing_StringParser.altParser)(Control_Alt.alt(Text_Parsing_StringParser.altParser)(Control_Alt.alt(Text_Parsing_StringParser.altParser)(Control_Alt.alt(Text_Parsing_StringParser.altParser)(Control_Alt.alt(Text_Parsing_StringParser.altParser)(Text_Parsing_StringParser["try"](addressParserA4))(Text_Parsing_StringParser["try"](addressParserA3)))(Text_Parsing_StringParser["try"](addressParserA2)))(Text_Parsing_StringParser["try"](addressPostalParserA4)))(Text_Parsing_StringParser["try"](addressPostalParserA3)))(Text_Parsing_StringParser["try"](addressPostalParserA2));
  ...
  exports["ruralAddressLine"] = ruralAddressLine;
  exports["poBox"] = poBox;
  ...
  var main = Test_Spec_Runner.run([ Test_Spec_Reporter_Console.consoleReporter ])(Test_Spec.describe("Address Parser")(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Test_Spec.describe("Residential addresses tests")(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Test_Spec.it("with 2 lines")(Test_Spec_Assertions.shouldEqual(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Test_Spec.it("with 3 lines")(Test_Spec_Assertions.shouldEqual(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Test_Spec.it("with 4 lines")(Test_Spec_Assertions.shouldEqual(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Test_Spec.it("with 4 lines and sepecial characters in flatStreet")(Test_Spec_Assertions.shouldEqual(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "flatStreet";
              }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "line1";
              }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Test_Spec.it("rural with 3 lines")(Test_Spec_Assertions.shouldEqual(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "flatStreet";
                  }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "line1";
                  }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "flatStreet";
                  }))(Data_Eq.eqString)))(AddressParser.get("255A Renwick Road, RD 3, Kaikohe 0473"))({
                      flatStreet: "255A",
                      line1: "Renwick Road",
                      line2: "RD 3",
                      line3: "",
