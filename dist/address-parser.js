...
(function($PS) {
  ...
  var Text_Parsing_StringParser_Combinators = $PS["Text.Parsing.StringParser.Combinators"];
  var A2 = (function () {
      function A2(value0, value1, value2, value3) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
          ...
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return new A2(value0, value1, value2, value3);
                  };
              };
          };
      };
  ...
  var A3 = (function () {
      function A3(value0, value1, value2, value3, value4) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
              ...
              return function (value2) {
                  return function (value3) {
                      return function (value4) {
                          return new A3(value0, value1, value2, value3, value4);
                      };
                  };
              };
          };
  ...
  var A4 = (function () {
      function A4(value0, value1, value2, value3, value4, value5) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
                  ...
                  return function (value3) {
                      return function (value4) {
                          return function (value5) {
                              return new A4(value0, value1, value2, value3, value4, value5);
                          };
                      };
                  };
              };
  ...
  var toString = function (dictFunctor) {
      return function (dictFoldable) {
          return Data_Functor.map(dictFunctor)((function () {
              var $133 = Data_String_Yarn.fromChars(Data_Foldable.foldableArray);
              var $134 = Data_Array.fromFoldable(dictFoldable);
              return function ($135) {
                  return $133($134($135));
              };
          })());
  ...
  var showAddress = new Data_Show.Show(function (v) {
      if (v instanceof A2) {
          return "A2 [" + (v.value0 + ("|" + (v.value1 + ("|" + (v.value2 + ("|" + (v.value3 + "]")))))));
      };
      if (v instanceof A3) {
          return "A3 [" + (v.value0 + ("|" + (v.value1 + ("|" + (v.value2 + ("|" + (v.value3 + ("|" + (v.value4 + "]")))))))));
      };
      if (v instanceof A4) {
          return "A4 [" + (v.value0 + ("|" + (v.value1 + ("|" + (v.value2 + ("|" + (v.value3 + ("|" + (v.value4 + ("|" + (v.value5 + "]")))))))))));
      };
      if (v instanceof Invalid) {
          return "Invalid";
      };
      throw new Error("Failed pattern match at AddressParser (line 36, column 1 - line 40, column 31): " + [ v.constructor.name ]);
  });                                                     
  ...
  var eqAddress = new Data_Eq.Eq(function (v) {
      return function (v1) {
          if (v instanceof A4 && v1 instanceof A4) {
              return v.value0 === v1.value0 && (v.value1 === v1.value1 && (v.value2 === v1.value2 && (v.value3 === v1.value3 && (v.value4 === v1.value4 && v.value5 === v1.value5))));
          };
          if (v instanceof A3 && v1 instanceof A3) {
              return v.value0 === v1.value0 && (v.value1 === v1.value1 && (v.value2 === v1.value2 && (v.value3 === v1.value3 && v.value4 === v1.value4)));
          };
          if (v instanceof A2 && v1 instanceof A2) {
                      ...
                      return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(addressLine)(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
                              return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(postcode)(function (v3) {
                                  return Control_Applicative.pure(Text_Parsing_StringParser.applicativeParser)(new A2(v, v1, Data_String_Common.trim(v2), v3));
                              });
                          });
                      });
                  });
                                  ...
                                  return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(addressLine)(function (v3) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
                                          return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(postcode)(function (v4) {
                                              return Control_Applicative.pure(Text_Parsing_StringParser.applicativeParser)(new A3(v, v1, v2, Data_String_Common.trim(v3), v4));
                                          });
                                      });
                                  });
                              });
                                              ...
                                              return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(addressLine)(function (v4) {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
                                                      return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(postcode)(function (v5) {
                                                          return Control_Applicative.pure(Text_Parsing_StringParser.applicativeParser)(new A4(v, v1, v2, v3, Data_String_Common.trim(v4), v5));
                                                      });
                                                  });
                                              });
                                          });
              ...
              return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(addressLine)(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
                      return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(postcode)(function (v2) {
                          return Control_Applicative.pure(Text_Parsing_StringParser.applicativeParser)(new A2("", v, Data_String_Common.trim(v1), v2));
                      });
                  });
              });
          });
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipComma)(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
                          return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(addressLine)(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
                                  return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(postcode)(function (v3) {
                                      return Control_Applicative.pure(Text_Parsing_StringParser.applicativeParser)(new A3("", v, v1, Data_String_Common.trim(v2), v3));
                                  });
                              });
                          });
                      });
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipComma)(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
                                      return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(addressLine)(function (v3) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(skipWhitespaces)(function () {
                                              return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(postcode)(function (v4) {
                                                  return Control_Applicative.pure(Text_Parsing_StringParser.applicativeParser)(new A4("", v, v1, v2, Data_String_Common.trim(v3), v4));
                                              });
                                          });
                                      });
                                  });
  ...
  var residentialParser = Control_Alt.alt(Text_Parsing_StringParser.altParser)(Control_Alt.alt(Text_Parsing_StringParser.altParser)(Control_Alt.alt(Text_Parsing_StringParser.altParser)(Control_Alt.alt(Text_Parsing_StringParser.altParser)(Control_Alt.alt(Text_Parsing_StringParser.altParser)(Text_Parsing_StringParser["try"](addressPostalParserA2))(Text_Parsing_StringParser["try"](addressPostalParserA3)))(Text_Parsing_StringParser["try"](addressPostalParserA4)))(Text_Parsing_StringParser["try"](addressParserA3)))(Text_Parsing_StringParser["try"](addressParserA4)))(Text_Parsing_StringParser["try"](addressParserA2));
  exports["A2"] = A2;
  exports["A3"] = A3;
  exports["A4"] = A4;
...
(function($PS) {
  ...
  var Text_Parsing_StringParser = $PS["Text.Parsing.StringParser"];                
  var main = Test_Spec_Runner.run([ Test_Spec_Reporter_Console.consoleReporter ])(Test_Spec.describe("Address Parser")(Test_Spec.describe("Valid Address Formats")(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Test_Spec.it("Parse \"123 street, city 1234\"")((function () {
      var result = Text_Parsing_StringParser.runParser(AddressParser.residentialParser)("123 street, city 1234");
      var output = Data_Either.either(function (v) {
          return new AddressParser.A2("", "", "", "");
      })(function (x) {
          return x;
      })(result);
      return Test_Spec_Assertions.shouldEqual(AddressParser.showAddress)(AddressParser.eqAddress)(output)(new AddressParser.A2("123", "street", "city", "1234"));
  })()))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Test_Spec.it("Parse \"123/A Long Street, Wide City 1234\"")((function () {
          var result = Text_Parsing_StringParser.runParser(AddressParser.residentialParser)("123/A Long Street, Wide City 1234");
          var output = Data_Either.either(function (v) {
              return new AddressParser.A2("", "", "", "");
          })(function (x) {
              return x;
          })(result);
          return Test_Spec_Assertions.shouldEqual(AddressParser.showAddress)(AddressParser.eqAddress)(output)(new AddressParser.A2("123/A", "Long Street", "Wide City", "1234"));
      })()))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Test_Spec.it("Parse \"123/A Long Street, Fanatasy Suburb, Wide City 1234\"")((function () {
              var result = Text_Parsing_StringParser.runParser(AddressParser.residentialParser)("123/A Long Street, Fanatasy Suburb, Wide City 1234");
              var output = Data_Either.either(function (v) {
                  return new AddressParser.A3("", "", "", "", "");
              })(function (x) {
                  return x;
              })(result);
              return Test_Spec_Assertions.shouldEqual(AddressParser.showAddress)(AddressParser.eqAddress)(output)(new AddressParser.A3("123/A", "Long Street", "Fanatasy Suburb", "Wide City", "1234"));
          })()))(function () {
              return Test_Spec.it("Parse \"12/3A Long Street, Fanatasy Suburb, Area, Wide City 1234\"")((function () {
                  var result = Text_Parsing_StringParser.runParser(AddressParser.residentialParser)("12/3A Long Street, Fanatasy Suburb, Area, Wide City 1234");
                  var output = Data_Either.either(function (v) {
                      return new AddressParser.A4("", "", "", "", "", "");
                  })(function (x) {
                      return x;
                  })(result);
                  return Test_Spec_Assertions.shouldEqual(AddressParser.showAddress)(AddressParser.eqAddress)(output)(new AddressParser.A4("12/3A", "Long Street", "Fanatasy Suburb", "Area", "Wide City", "1234"));
              })());
          });
      });
  }))));
